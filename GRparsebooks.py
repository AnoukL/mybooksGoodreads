...
SAVEDGENRES = "E:\Dataprojects\goodreads\goodreadsGenres.pkl"
...
def getUserBooks(shelf):
	...
	logging.info(f"Result from api request is {response}")
...
def getRatings(sourceList):
	logging.info("Getting rating for book")
	avgRating = []
...
def getBooksonShelf(shelf):
	...
	logging.info(f"Result after bs4 processing is {myBooks}")
